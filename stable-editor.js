...
<div class="ed-panel" data-panel="ai" hidden><b>AI ASSISTANT <span class="ed-pro">PRO</span></b><button type="button" id="edAiText">✨ Generate Text</button><button type="button" id="edAiDesign">✨ Suggest Design</button><p id="edAiResult" class="ed-help"></p></div>
